...
app.post("/", upload.single("file"), PictureController.create);
app.get("/", PictureController.findAll);
app.delete("/:id", PictureController.remove);
app.patch("/:id",  upload.single("file"), PictureController.update);
